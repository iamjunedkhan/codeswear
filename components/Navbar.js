        ...
        <div className='py-2 flex flex-col justify-center items-center md:flex-row md:justify-start shadow-md'>
            ...
            <div ref={ref} className='cartSideBar w-80 max-h-full overflow-y-auto bg-pink-200 fixed top-0 right-0 py-10 px-5  translate-x-full transition-transform '>
                ...
                <ol className='list-decimal ml-5 '>
                    <li className='my-4'>
                        <div className='flex  justify-center items-center space-x-2 font-bold'>
                            <div >T shirt-wear the code how are your i m afine</div>
                            <div className='flex justify-center items-center text-xl'>
                                <AiFillPlusCircle className='text-pink-600' />
                                <span className='m-2'>1</span>
                                <AiFillMinusCircle className='text-pink-600' />
                            </div>
                        </div>
                    </li>
                ...
                <div className='flex'>
                    ...
                    <button class="flex mx-auto mt-16 text-white bg-pink-500 border-0 py-1 px-5 focus:outline-none hover:bg-pink-600 rounded text-lg">Clear Cart</button>
                </div>
            </div>
        </div>
    )
